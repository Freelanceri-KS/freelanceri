...
const DetailsPage = () => {
  ...
  const token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NWZlMzQ5ODkwNTZkYTBmMDE2YjU0MDQiLCJpYXQiOjE3MTE0ODM3ODcsImV4cCI6MTcxMTc0Mjk4N30.-P5wqsMjulVxfM_Oysa5yaLrtiJkrGszukCKZy9_4S8";
  ...
  // "https://weak-lime-squid-fez.cyclic.app/posts/1"

  const getJobDetail = () => {
    axios
      .get(`https://weak-lime-squid-fez.cyclic.app/posts/${id}`, config)
      ...
      <div className="dp-center">
        <div className="dp-center-mainpost">
          ...
          <div className="mainpost-description">
            <p>
              I'm on a mission to transform my room into a cozy sanctuary, and
              I'm reaching out to the creative minds out there for some
              inspiration!
              <br />
              ...
              laughter, and all the special details, we want to hear from you!
              <br />
              <br />
              About My Room: Size: [Dimensions] Current Style: [Brief
              description, e.g., minimalist, eclectic] Desired Vibes: [Mention
              the ambiance you're aiming for]
              <br />
              <br />
              Let's make this room transformation a collaborative masterpiece!
              Your ideas could be the missing piece to my dream space.
            </p>
          </div>
