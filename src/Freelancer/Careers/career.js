                        ...
                        <div className="career-values-right">
                            <div className="cvr-item">
                                <div className="cvri-box">
                                    <img src={Training} alt="Training" width={32} height={32} />
                                </div>
                            ...
                            <div className="cvr-item">
                                <div className="cvri-box">
                                    <img src={Mentoring} alt="Mentoring" width={32} height={32} />
                                </div>
                                <div className="cvri-txt">
                            ...
                            <div className="cvr-item">
                                <div className="cvri-box">
                                    <img src={Exposure} alt="Mentoring" width={32} height={32} />
                                </div>
                                <div className="cvri-txt">
                            ...
                            <div className="cvr-item">
                                <div className="cvri-box">
                                    <img src={Growth} width={32} height={32} />
                                </div>
                                <div className="cvri-txt">
