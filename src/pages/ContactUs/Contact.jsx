  ...
  return (
    <div className="contact-form-container">
     ...
     <div className="text-contact">
          ...
          <p className='contact-text__second'>
            If you're an employer (Business or Individual) and you have questions  <br /> or recruiting needs, fill this form and we will contact you shortly.</p>
            
      </div>
      <div className="form-container">
      <img className="foto-blackpretty" src={Images} alt="Cropped shot" />
        ...
        <form>
          ...
          <button className='button-responsive' type="submit">Submit</button>
        </form>
      </div>
